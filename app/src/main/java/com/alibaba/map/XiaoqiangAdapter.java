...
public class XiaoqiangAdapter extends RecyclerView.Adapter<XiaoqiangAdapter.Vh> {

    Context mContext;
    LayoutInflater mInflater;
    ArrayList<ArrayList<Tiny2>> mTinyList;

    public XiaoqiangAdapter(Context context, ArrayList<ArrayList<Tiny2>> tinyList) {
        mContext = context;
                        ...
                        if (tiny.get(i).getAskType() == MainActivity.ASK_NONE) {
                            switch (tiny.get(i).getBet1()) {
                                ...
                                case MainActivity.XIAN_YIN:
                                    ivBetArr[i].setImageResource(R.mipmap.gaza_blue);
                                    break;
                            }
